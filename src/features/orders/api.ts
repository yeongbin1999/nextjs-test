...
import type { OrderRequestDTO, OrderDetailDTO, OrderListDTO } from '@/lib/backend/apiV1/api';

// 주문 생성
export const createOrder = async (orderData: OrderRequestDTO): Promise<OrderDetailDTO> => {
